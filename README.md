...
```
#### hasil:
![image](https://github.com/fantasiavsr/project-big-data-ML-2023/docs/img/category.png)
...
```
#### hasil:
![image](https://github.com/fantasiavsr/project-big-data-ML-2023/docs/img/wordcloud.png)
